...
public class APIController extends BaseController {
    ...
    public void createSMSMessageAsync(
        ...
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5690970850246543287L;
            {
    ...
    public void getAuthenticationAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4746571063574024711L;
            {
        ...
        //load all headers for the outgoing API request
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5124533523333839355L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
            }
    ...
    public void getMessageStatusAsync(
        ...
        APIHelper.appendUrlWithTemplateParameters(queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4636441165861519747L;
            {
        ...
        //load all headers for the outgoing API request
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5280981140787467689L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "Authorization", String.format("Bearer %1$s", Configuration.oAuthAccessToken) );
    ...
    public void getMessageResponseAsync(
        ...
        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5698075901255060283L;
            {
                    put( "messageID", messageID );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4619055927444857582L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "Authorization", String.format("Bearer %1$s", Configuration.oAuthAccessToken) );
            }
